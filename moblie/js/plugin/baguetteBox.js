...
var baguetteBox = (function() {
    ...
    function run(selector, userOptions) {
                ...
                [].forEach.call(
                    ...
                    function (imageElement, imageIndex) {
                        bind(imageElement, 'click', function(event) {
							...
							$("#"+sliderID).delegate("img","click",function(){
								var thisimgurl = $(this).attr("src");
								$("#imgurl_id").attr("src",thisimgurl);
								addDiv.addClass("visible").show();
								$("body").undelegate("#imgurl_id,.custom-close","click").delegate("#imgurl_id,.custom-close","click",function(){
									removediv();
								});
								function removediv(){
									addDiv.removeClass("visible").hide();	
								}
							});
                        });
                    }
		...
		//点击图片放大
		var addDiv = $('<div id="baguetteBox-overlay-add"><div id="baguetteBox-adddiv"><img id="imgurl_id" src="" /></div><span class="custom-close"></span></div>');	
		//$('body').append(addDiv);
    ...
    function buildOverlay() {
		...
		tipfd = document.createElement('div');
        tipfd.id = 'tipfd-div';
        tipfd.innerHTML = '单击图片看大图';
        overlay.appendChild(tipfd);
