//滚动图片构造函数
function ScrollPic(scrollContId,arrLeftId,arrRightId,dotListId,listType,autoPlay,callback,imgwcallback){
  ...
  this.imgwcallback = imgwcallback;//回调函数
...
ScrollPic.prototype = {
  ...
  initialize : function(){ //初始化
	...
	var pages = $(this.scDiv).find(".mod_01").size()/2;
