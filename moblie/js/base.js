	...
	var getCartInit	= function(){
		...
		AjaxFunUtils.ajaxInit({
			...
			callback:function(res){
				...
				if(itemnum > 0){
					$("#cartItemnum").text(itemnum).show();	
				}else{
					$("#cartItemnum").text('0').show();	
				}
...
var BaseInitClass = function(){
	...
	return {baseInit:baseInit,bindmobile:bindmobile,followBtn:followBtn,getQueryString:getQueryString,checksearchTagbox:checksearchTagbox,loginCheck:loginCheck,upcontainer:upcontainer}
}();
